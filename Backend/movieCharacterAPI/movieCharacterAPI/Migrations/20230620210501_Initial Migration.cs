    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Francise", x => x.FranchiseId);
                });
            ...
            migrationBuilder.CreateTable(
                name: "CharacterEntityMovieEntity",
                columns: table => new
                {
                    CharacterId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CharacterEntityMovieEntity", x => new { x.CharacterId, x.MoviesMovieId });
                    table.ForeignKey(
                        name: "FK_CharacterEntityMovieEntity_Characters_CharacterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CharacterEntityMovieEntity_MoviesMovieId",
